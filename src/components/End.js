  ...
  return (
    <div className="container">
            ...
            <div className="footer">
                ...
                <img src="https://coursados.com/wp-content/themes/learn4/img/footer-icons/visa_dark.png" alt="Visa"/>
            </div>
        	<div class="payment-method2">
                <img src="https://coursados.com/wp-content/themes/learn4/img/footer-icons/mastercard.png" alt="MasterCard/"/>
            </div>
            <div class="payment-method2">
                <img src="https://coursados.com/wp-content/themes/learn4/img/footer-icons/Maestro_2016.svg.png" alt="Maestro"/>
            </div>
            ...
            <div className="col-12 footer-bottom">
              ...
              <br></br>
                ...
                <div className='social-club'>
                    <a href='#'><img src='https://trustlock.co/wp-content/uploads/2019/01/credit-card-logos-free-png-image-trans.png'/></a>
                    <a href='#'><img src='https://trustlock.co/wp-content/uploads/2019/01/guaranteed-safe-checkout-5.png'/></a>
                    <a href='#'><img src='https://trustlock.co/wp-content/uploads/2019/01/stripe-logo-with-credit-card-logos.png'/></a>
                </div>
            </div>
        </div>
    </div>
